...
## Limitations & Future Improvements
 ...
 Using many low‑power resistors **increases size** and soldering complexity → replace with **fewer, higher‑power resistors**. - Zener‑based regulation is **temperature/tolerance sensitive** → consider an **integrated linear regulator (e.g., 7806)** for tighter tolerance and thermal behavior. - Add **current limiting / protection** and optionally more **parallel zeners** to improve robustness to ripple/tolerance variations.
